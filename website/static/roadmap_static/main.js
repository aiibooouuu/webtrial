document.addEventListener("DOMContentLoaded", function(){
    ...
    var tempblock;
    var tempblock2;
    document.getElementById("blocklist").innerHTML = '<div class="blockelem create-flowy noselect"><input type="hidden" name="blockelemtype" class="blockelemtype" value="1"><div class="grabme">🔗</div><div class="blockin">                  <div class="blockico"><span></span>⌚</div><div class="blocktext">                        <p class="blocktitle" >Step Priority-Least</p><p class="blockdesc"></p>        </div></div></div><div class="blockelem create-flowy noselect"><input type="hidden" name="blockelemtype" class="blockelemtype" value="2"><div class="grabme">🔗</div><div class="blockin">                    <div class="blockico"><span></span>👁️</div><div class="blocktext">                        <p class="blocktitle">Step Priority-Mid</p><p class="blockdesc"></p></div></div></div><div class="blockelem create-flowy noselect"><input type="hidden" name="blockelemtype" class="blockelemtype" value="3"><div class="grabme">🔗</div><div class="blockin">                    <div class="blockico"><span></span>⚡</div><div class="blocktext">                        <p class="blocktitle">Step Priority-High</p><p class="blockdesc"></p>          </div></div></div><div class="blockelem create-flowy noselect"><input type="hidden" name="blockelemtype" class="blockelemtype" value="4"><div class="grabme">🔗</div><div class="blockin">                    <div class="blockico"><span></span>🔥</div><div class="blocktext">                        <p class="blocktitle">Step Priority-Maximum </p><p class="blockdesc"></p>              </div></div></div>';
    ...
    function snapping(drag, first) {
        ...
        if (drag.querySelector(".blockelemtype").value == "1") {
            drag.innerHTML += "<div class='blockico'><span></span>⌚</div><div class='blockyleft'><textarea placeholder='Write Content...' rows='5' cols='15'></textarea></div><div class='blockyright'>🔗<div class='tick'><input class='checkbox' type='checkbox'></div></div><div class='blockydiv'></div>";
        } else if (drag.querySelector(".blockelemtype").value == "2") {
            drag.innerHTML += "<div class='blockico'><span></span>👁️</div><div class='blockyleft'><textarea placeholder='Write Content...' rows='5' cols='15' ></textarea></div><div class='blockyright'>🔗<div class='tick'><input class='checkbox' type='checkbox'></div></div><div class='blockydiv'></div>";
            ...
            drag.innerHTML += "<div class='blockico'><span></span><img src='assets/eye.svg'></div><div class='blockyleft'><textarea rows='5 cols='15'></textarea></div><div class='blockyright'><img src='assets/more.svg'></div><div class='blockydiv'></div>";
        } else if (drag.querySelector(".blockelemtype").value == "6") {
            drag.innerHTML += "<div class='blockico'><span></span><img src='assets/eye.svg'></div><div class='blockyleft'><textarea rows='7' cols='15'></textarea></div><div class='blockyright'><img src='assets/more.svg'></div><div class='blockydiv'></div>";
        } else if (drag.querySelector(".blockelemtype").value == "7") {
            drag.innerHTML += "<div class='blockico'><span></span><img src='assets/eye.svg'></div><div class='blockyleft'><textarea rows='7 'column='15'></textarea></div><div class='blockyright'><img src='assets/more.svg'></div><div class='blockydiv'></div>";
